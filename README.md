...
- Release: [v0.1.4](https://github.com/beepboop2025/financial-evidence-skills/releases/tag/v0.1.4)
- Install: `python -m pip install "financial-evidence[openbb] @ https://github.com/beepboop2025/financial-evidence-skills/releases/download/v0.1.4/financial_evidence-0.1.4-py3-none-any.whl"`, then run `openbb-build`
